...
async function account(req, res) {
    ...
    res.render("account", {
        ...
        chats,
        title: "Account",
        description: "Manage your Sage Ai account",
    });
}
...
async function signup(req, res) {
    try {
        ...
        if (!order) throw new Error("Couldn't find an order for this session. If you just purchased please wait a minute and try again, or contact bscs3ase@gmail.com");

        return res.render("signup", {
            session_id,
            order,
            title: "Signup",
            description: "Signup to Sage Ai",
        });
    } catch (e) {
        return res.render("signup", {
            error: e.message,
