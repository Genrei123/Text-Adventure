const SageAIAPI = require('./api');
const SageAIGame = require('./game');
...
class SageAI {
    ...
    async handleGame(game, options = null) {
        this.game = new SageAIGame(this, game);
    ...
    static async initialize(api) {
        ...
        console.log(`initialized SageAI with session_id ${ia.session_id}`);
        return ia;
    }
