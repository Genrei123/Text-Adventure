...
const getPlayers = async (req, res) => {
    ...
    let query = 'SELECT * FROM "Users" WHERE "emailVerified" = true'; // Only fetch verified users
    if (search)
    ...
    try {
        ...
        const total = await sequelize_1.default.query('SELECT COUNT(*) FROM "Users" WHERE "emailVerified" = true', { type: sequelize_2.QueryTypes.SELECT });
