    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                if (email) {
                    const response = await axios.get(`http://localhost:3000/gameplay/coins/${email}`);
        ...
        <nav className="bg-[#1E1E1E] py-[1.06rem] px-0 shadow-[0_7px_3px_0_rgba(0,0,0,0.75)] z-50">
            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center">                     
                    ...
                    <br></br>
                    <span className="text-x1 font-cinzel text-[#ffffff] font-bol">{new Intl.NumberFormat().format(totalCoins)}</span>
