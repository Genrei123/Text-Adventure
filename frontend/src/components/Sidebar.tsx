        ...
        <>
            ...
            <div className="block md:hidden w-full p-1 top-16 left-0 h-50 absolute">
                <ul className="flex justify-around">
                    <li className="flex justify-center items-center cursor-pointer m-1.5 relative group">
                        <img src="src/assets/Home.svg" className="w-6 h-6 group-hover:opacity-0" />
                        <img src="src/assets/Home-after.svg" className="w-6 h-6 absolute top-0 left-0 opacity-0 group-hover:opacity-100" />
                    </li>
                    <li className="flex justify-center items-center cursor-pointer m-1.5 relative group">
                        <img src="src/assets/Settings.svg" className="w-6 h-6 group-hover:opacity-0" />
                        <img src="src/assets/Settings-after.svg" className="w-6 h-6 absolute top-0 left-0 opacity-0 group-hover:opacity-100" />
                    </li>
                    <li className="flex justify-center items-center cursor-pointer m-1.5 relative group">
                        <img src="src/assets/Message.svg" className="w-8 h-8 group-hover:opacity-0" />
                        <img src="src/assets/Message-after.svg" className="w-8 h-8 absolute top-0 left-0 opacity-0 group-hover:opacity-100" />
                    </li>
                    <li className="flex justify-center items-center cursor-pointer m-1.5 relative group">
                        <img src="src/assets/Any.svg" className="w-9 h-9 group-hover:opacity-0" />
                        <img src="src/assets/Any-after.svg" className="w-9 h-9 absolute top-0 left-0 opacity-0 group-hover:opacity-100" />
                    </li>
                </ul>
            </div>
        </>
