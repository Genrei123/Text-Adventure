...
const Sidebar: React.FC = () => {
    return (
        ...
        <div className="bg-[#1e1e1e] w-17 md:w-40 lg:w-60 h-screen fixed left-0 shadow-[10px_0_15px_-3px_rgba(0,0,0,10)] flex flex-col items-center justify-start pt-40">
